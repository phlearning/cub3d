...
/*   Updated: 2023/10/10 11:35:07 by pvong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_stock_info(t_data *data, t_map *map, char *line)
{
	...
	if (!tab || !tab[0] || !tab[1] || tab[2])
		error_exit2("Reason: wrong parameter(s)", 1);
